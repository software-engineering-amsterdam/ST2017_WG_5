...
-- Assignment 4, time: 8 hours
-- Getting a sudoku with 3 or 4 empty blocks is possible. I tested this 
-- by setting the max tries to 1000 and then tried to generate sudokus with
-- either 3 or 4 empty blocks. When I tried to generate sudokus with 5 empty blocks
-- I didnt get any.
